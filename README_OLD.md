...
**Firmware:** [IB Controller](./Firmware/IB%20Controller/)   
**Status:** ✓ Tested  
...
| [IB Controller](./Firmware/IB%20Controller/) | Keyboard Encoder Helper, Input Board Rev 1.0 | ATmega1284p | COB/VCS | Dual keyboard (PS/2 + matrix) to ASCII converter |
